#include "stdafx.h"
#include "IceMapScene.h"
#include "Objects/Player.h"
#include "Viewer/Freedom.h"
#include "Renders/Line.h"
#include "Viewer/Following.h"

IceMapScene::IceMapScene(SceneValues * values)
	:Scene(values)
{
